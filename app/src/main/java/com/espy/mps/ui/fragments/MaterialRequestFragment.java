...
public class MaterialRequestFragment extends BaseFragment implements DialogInteractionListener, WorkDetailsCallBack, GPSListener {
...
//                pictureIntent.putExtra("android.intent.extras.CAMERA_FACING", 1);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_material_request, container, false);
    ...
    public void onLocationUpdate(Location location, int i) {
        if (location != null) {
            ...
            new WebserviceUtils(getActivity()).insertMateralRequest(this, titleTxt, remarks, imageFilePath, projectid);
        }else {
            dismissProgress();
    ...
    public void onDetailsUploadSuccess(String response) {
        dismissProgress();
        new DialogueUtils(getActivity()).showSuccessDialog("SUCCESS", "Materials Request uploaded",
    ...
    public void onApiErrorResponse(String message, int type) {
        ...
        if (type == WORK_DEATAILS_PROJECT_NAMES_DOWNLOAD_ERROR){
            ...
            new DialogueUtils(getActivity()).showErrorDialog("OOPS!", "Materials Request upload failed",
