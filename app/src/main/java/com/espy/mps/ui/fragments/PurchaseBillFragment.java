...
public class PurchaseBillFragment extends BaseFragment implements DialogInteractionListener, WorkDetailsCallBack, GPSListener {
...
//                pictureIntent.putExtra("android.intent.extras.CAMERA_FACING", 1);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_purchase_bill, container, false);
    ...
    public void onLocationUpdate(Location location, int i) {
        if (location != null) {
            ...
            new WebserviceUtils(getActivity()).insertPurchaseBill(this, titleTxt, remarks, imageFilePath, vehicleNoTxt, projectid);
        }else {
            dismissProgress();
    ...
    public void onDetailsUploadSuccess(String response) {
        dismissProgress();
        new DialogueUtils(getActivity()).showSuccessDialog("SUCCESS", "Purchase bill details uploaded",
    ...
    public void onApiErrorResponse(String message, int type) {
        ...
        if (type == WORK_DEATAILS_PROJECT_NAMES_DOWNLOAD_ERROR){
            ...
            new DialogueUtils(getActivity()).showErrorDialog("OOPS!", "Purchase bill details upload failed",
