...
public class MaterailDetailsActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setToolbarProperties(true, "Materials Used", true);
        enableBottomBar(false);

        setFragment(new MaterialDetailsFragment(),MATERIAL_DETAILS_FRAGMENT,null);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        MaterialDetailsFragment fragment = (MaterialDetailsFragment ) getSupportFragmentManager().findFragmentByTag(MATERIAL_DETAILS_FRAGMENT);
        if (fragment != null) {
